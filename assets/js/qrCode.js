...
!(function () {
  ...
  (t.prototype = {
    ...
    (e.createData = function (t, r, n) {
      ...
      for (s.getLengthInBits() + 4 <= 8 * f && s.put(0, 4); 0 != s.getLengthInBits() % 8; ) s.putBit(!1);
  ...
  for (
    var s = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
      h = { L: 1, M: 0, Q: 3, H: 2 },
      u = { PATTERN000: 0, PATTERN001: 1, PATTERN010: 2, PATTERN011: 3, PATTERN100: 4, PATTERN101: 5, PATTERN110: 6, PATTERN111: 7 },
      l = {
        ...
        getLostPoint: function (t) {
          ...
          var l = 0;
          for (i = 0; e > i; i++) for (o = 0; e > o; o++) t.isDark(o, i) && l++;
    ...
    c = (function () {
      ...
      return (
        (t.prototype.draw = function (t) {
          ...
          var n = e("svg", { viewBox: "0 0 " + String(i) + " " + String(i), width: "100%", height: "100%", fill: r.colorLight });
          n.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xlink", "http://www.w3.org/1999/xlink"), o.appendChild(n), n.appendChild(e("rect", { fill: r.colorDark, width: "1", height: "1", id: "template" }));
          for (var a = 0; i > a; a++)
            for (var s = 0; i > s; s++)
              if (t.isDark(a, s)) {
        ...
        ? (function () {
            ...
            if (this._android && this._android <= 2.1) {
              ...
              CanvasRenderingContext2D.prototype.drawImage = function (t, e, i, n, a, s, h, u) {
                if ("nodeName" in t && /img/i.test(t.nodeName)) for (var l = arguments.length - 1; l >= 1; l--) arguments[l] = arguments[l] * r;
                ...
                for (var u = 0; i > u; u++)
                  for (var l = 0; i > l; l++) {
                    var f = t.isDark(u, l),
                      g = l * n,
                      d = u * a;
                    (r.strokeStyle = f ? o.colorDark : o.colorLight), (r.lineWidth = 1), (r.fillStyle = f ? o.colorDark : o.colorLight), r.fillRect(g, d, n, a), r.strokeRect(Math.floor(g) + 0.5, Math.floor(d) + 0.5, s, h), r.strokeRect(Math.ceil(g) - 0.5, Math.ceil(d) - 0.5, s, h);
                  }
                this._bIsPainted = !0;
              }),
  ...
  (QRCode = function (t, e) {
    if (((this._htOption = { width: 256, height: 256, typeNumber: 4, colorDark: "#000000", colorLight: "#ffffff", correctLevel: h.H }), "string" == typeof e && (e = { text: e }), e)) for (var r in e) this._htOption[r] = e[r];
